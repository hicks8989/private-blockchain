...
class Block {
     ...
     *  2. Save the block hash in auxiliary variable the current hash of the block (`this` represent the block object)
    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            ...
            // Get block height to determine if block is genesis block.
            if (self.height <= 0) {
